class User(object):
    ...
    def serialize(user):
        ...
        print "compensation: {}, {}, {}".format(user.person.employee_compensation.annual_base_salary, user.person.employee_compensation.projected_hour_per_month, user.person.employee_compensation.hourly_rate)
