...
class EmployeeProfileSerializer(object):
    ...
    def serialize(profile, file, person_id_string):
        ...
        file.write('  VALUES(\'\', {}, \'{}\', \'{}\', \'{}\', now(), now(), {}, company_id, {}, \'{}\');\n'.format(profile.annual_base_salary, Serializer.get_date_string(profile.start_date), profile.employment_type, EmployeeProfileSerializer.get_employment_status(profile.employment_status), person_id_string, EmployeeProfileSerializer.get_pay_rate_id(profile.pay_rate), Serializer.get_date_string(profile.benefit_start_date)))
        file.write('\n')
