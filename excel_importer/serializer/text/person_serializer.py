class PersonSerializer(object):
    ...
    def serialize(person, f):
        if not f:
            return
        if person:
            f.write("person: {}, {}, {}, {}, {}\n".format(person.first_name, person.last_name, person.birth_date, person.ssn, person.gender))
            if person.address:
            ...
            if person and person.employee_profile:
                f.write("profile: {}, {}\n".format(person.employee_profile.employment_status, person.employee_profile.start_date))
            else:
                f.write("No employee profile\n")
            if person and person.employee_compensation:
                f.write("compensation: {}, {}, {}, {}\n".format(person.employee_compensation.annual_base_salary, person.employee_compensation.hours, person.employee_compensation.hourly_rate, person.employee_compensation.effective_date))
            else:
