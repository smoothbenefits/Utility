...
class EmployeeProfileSerializer(object):
    ...
    def serialize(profile, file, person_id_string, id):
        ...
        if profile.department:
            ...
            file.write('    INSERT INTO app_companydepartment(name, description, company)\n')
        ...
        file.write('  INSERT INTO app_employeeprofile(job_title, start_date, employment_type, employment_status, created_at, updated_at, person_id, company_id, benefit_start_date, employee_number, department)\n')
