...
class EmployeeCompensationParser(ModelParserBase):
    ...
    def _setup_column_index_mapping(self):
        self.column_index_property_mapping = {
            20: (lambda value, model: self._set_number_value_on_model(model, 'annual_base_salary', value)),
            21: (lambda value, model: self._set_number_value_on_model(model, 'hours', value)),
