...
class DirectDepositParser(ModelParserBase):
    ...
    def _setup_column_mapping(self):
        self.column_property_mapping = {
            ...
            'employee direct deposit 1 account bank name': (lambda value, model: setattr(model, 'account_1_bank_name', value)),
            ...
            'employee direct deposit 2 account bank name': (lambda value, model: setattr(model, 'account_2_bank_name', value)),
            ...
            'employee direct deposit 3 account bank name': (lambda value, model: setattr(model, 'account_3_bank_name', value)),
